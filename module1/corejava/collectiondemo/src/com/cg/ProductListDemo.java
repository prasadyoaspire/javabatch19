...
public class ProductListDemo {
	...
	public static void main(String[] args) {
		...
		p4.setProductId(20);
		p4.setProductName("LenovoX");
		p4.setProductPrice(78000);
		p4.setMfd(LocalDate.of(2021, 10, 10));
...
//		Set<Product> products = new HashSet<>();
		...
		//task1: search product by productId
		
		//task2: sum of all the product prices
